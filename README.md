...
<html>
    ...
    <p><font color="#222b2e"style="font-size:20px"/>Посмотрите краткий видеоролик «На что способен Ягдтерьер» нажав на картинку!</p>
    <a href="https://youtu.be/heHLijDyQOk"><img src="https://minthost.ru/wp-content/uploads/2020/08/nemeczkij-yagdterer.-ohotnichya-sobaka-5-1.jpg"></a></img src>
    <h2 id="dog" style="text-align:center">Характеристика породы</h2>
        <table style="border:20px solid black;text-align:center;background-color:white;font-size:20px">
        <tr>
           <td style="border:1px solid black">Род</td>
           <td style="border:1px solid black">Вес</td>
           </tr>
           <tr>
               <td style="border:1px solid black">Мальчик</td>
               <td style="border:1px solid black">9-10кг</td>
               </tr>
               <tr>
                   <td style="border:1px solid black">Девочка</td>
                   <td style="border:1px solid black">7.5-8.5кг</td>
               </tr>
           </table>
